...
💌 Now type here:`)))
         ...
         if (!Object.keys(PHONENUMBER_MCC).some(v => phoneNumber.startsWith(v))) {
            ...
            phoneNumber = await question(chalk.bgBlack(chalk.greenBright(`ᗯEᒪᑕOᗰE TO ᗰᗩᖇIEGOᒪᗪ-ᗰᗪ ᗷOT ᑭᗩIᖇ ᑭᗩGE.
...
//------------------------------------------------------
    ...
    XeonBotInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
            ...
            await XeonBotInc.sendMessage(XeonBotInc.user.id, { text: `🪩ᴛʜᴇ ᴍᴀʀɪᴇɢᴏʟᴅ-ᴍᴅ ʙᴏᴛ ᴄᴏᴅᴇ ʜᴀꜱ ʙᴇᴇɴ ᴘᴀɪʀᴇᴅ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ✅



💌ɢɪᴠᴇ ᴀ sᴛᴀʀ ᴛᴏ ᴍʏ ʀᴇᴘᴏ ғᴏʀ ᴄᴏᴜʀᴀɢᴇ ✨

https://github.com/piku090909/MarieGold-MD
...
https://chat.whatsapp.com/GYHWrfojqqM2x7YLfMZilz
...
https://whatsapp.com/channel/0029Vb3GzZp0bIdru2SXbD3a
